...
It appears form the graph, that a larger carat diamond tends to be more expensive, but also that a diamond with a better clarity can make up for a lower carat value.
